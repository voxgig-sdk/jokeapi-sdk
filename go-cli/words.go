...
func registerSDKWords(r *eng.Registry, client *sdk.JokeapiSDK) {
...
func runOp(client *sdk.JokeapiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
