...
|---|---|---|
| `ts/` | @voxgig-sdk/jokeapi-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/jokeapi-sdk \
      --repository voxgig-sdk/jokeapi-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/jokeapi-sdk` shows it, and
`npm trust revoke @voxgig-sdk/jokeapi-sdk --id=<id>` removes it.
