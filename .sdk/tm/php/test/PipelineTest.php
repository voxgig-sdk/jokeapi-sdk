...
{
    private static function utility(): JokeapiUtility
    {
        return new JokeapiUtility();
    }
    ...
    private static function ctx(array $over = []): JokeapiContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new JokeapiContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new JokeapiOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof JokeapiError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new JokeapiOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = JokeapiMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new JokeapiOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = JokeapiMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new JokeapiOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = JokeapiMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new JokeapiSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = JokeapiMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new JokeapiResponse([]),
            'result' => new JokeapiResult([]),
        ]);
        [, $err] = JokeapiMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new JokeapiSpec([]),
            'response' => null,
            'result' => new JokeapiResult([]),
        ]);
        [, $err] = JokeapiMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new JokeapiSpec(['step' => 's']),
            'response' => new JokeapiResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new JokeapiResult([]),
        ]);
        [, $err] = JokeapiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new JokeapiSpec(['step' => 's']),
            'response' => new JokeapiResponse(self::resp(200, ['v' => 1])),
            'result' => new JokeapiResult([]),
        ]);
        [, $err] = JokeapiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new JokeapiSpec(['step' => 's']),
            'response' => new JokeapiResponse(self::resp(200, ['v' => 2])),
            'result' => new JokeapiResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        JokeapiMakeResponse::call($ctx);
    ...
    {
        $preset = new JokeapiResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new JokeapiSpec([]),
            'response' => new JokeapiResponse([]),
            'result' => new JokeapiResult([]),
        ...
        [$got, $err] = JokeapiMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new JokeapiResult([])]);
        [, $err] = JokeapiMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new JokeapiSpec([]), 'result' => null]);
        [, $err] = JokeapiMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new JokeapiSpec(['step' => 's']),
            'result' => new JokeapiResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new JokeapiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = JokeapiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new JokeapiSpec(['step' => 's']),
            'result' => new JokeapiResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new JokeapiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = JokeapiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new JokeapiResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new JokeapiSpec([]),
            'result' => new JokeapiResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = JokeapiMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = JokeapiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new JokeapiError('boom', 'boom');
        $utility->fetcher = function (JokeapiContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new JokeapiSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = JokeapiMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (JokeapiContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = JokeapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(JokeapiResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (JokeapiContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new JokeapiSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = JokeapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new JokeapiResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new JokeapiSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = JokeapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = JokeapiMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = JokeapiMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new JokeapiResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, JokeapiDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new JokeapiResult(['ok' => false])]);
        $this->expectException(JokeapiError::class);
        JokeapiDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new JokeapiResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', JokeapiMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        JokeapiMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new JokeapiBaseFeature();
        $b = new JokeapiBaseFeature();
        JokeapiFeatureAdd::call($ctx, $a);
        JokeapiFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): JokeapiBaseFeature
    {
        $f = new JokeapiBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        JokeapiFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): JokeapiContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new JokeapiSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = JokeapiPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new JokeapiResponse(['headers' => null]),
            'result' => new JokeapiResult([]),
        ]);
        JokeapiResultHeaders::call($ctx);
