...
// Jokeapi SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = JokeapiOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(JokeapiOmni::structfix($now, Struct::undef()))
                        !== json_encode(JokeapiOmni::structfix($val, Struct::undef()))) {
