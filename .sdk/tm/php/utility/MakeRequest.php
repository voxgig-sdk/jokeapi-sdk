...
// Jokeapi SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class JokeapiMakeRequest
{
    public static function call(JokeapiContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new JokeapiResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new JokeapiResponse($fetched);
        } else {
