...
class JokeapiNetsimFeature extends JokeapiBaseFeature
{
    ...
    private function _simulate(JokeapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(JokeapiContext $ctx, array $applied): void
    {
        $client = $this->client;
