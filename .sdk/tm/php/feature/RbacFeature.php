...
class JokeapiRbacFeature extends JokeapiBaseFeature
{
    ...
    private function _required(JokeapiContext $ctx): ?string
    {
    ...
    private function _reject(JokeapiContext $ctx, string $required): void
    {
    ...
    private function _track(JokeapiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
