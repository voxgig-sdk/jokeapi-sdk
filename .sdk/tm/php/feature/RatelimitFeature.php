...
class JokeapiRatelimitFeature extends JokeapiBaseFeature
{
    ...
    private function _acquire(JokeapiContext $ctx): void
    {
    ...
    private function _track(JokeapiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
