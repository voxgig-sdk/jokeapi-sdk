...
class JokeapiProxyFeature extends JokeapiBaseFeature
{
    ...
    public function init(JokeapiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (JokeapiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
