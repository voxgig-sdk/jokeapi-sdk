...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = JokeapiOmni.make_runner(TEST_JSON_FILE, JokeapiSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : JokeapiOmni.errify(err)
    end
