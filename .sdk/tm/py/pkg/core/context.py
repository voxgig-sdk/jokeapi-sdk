...
from projectname_sdk.core.control import JokeapiControl
...
class JokeapiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, JokeapiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return JokeapiError(code, msg, self)
