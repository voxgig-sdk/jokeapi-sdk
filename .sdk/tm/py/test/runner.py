...
class JokeapiTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = JokeapiTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = JokeapiTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = JokeapiTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
