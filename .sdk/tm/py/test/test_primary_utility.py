...
from projectname_sdk import JokeapiSDK
from projectname_sdk.core.spec import JokeapiSpec
from projectname_sdk.core.result import JokeapiResult
from projectname_sdk.core.response import JokeapiResponse
from projectname_sdk.core.operation import JokeapiOperation
from projectname_sdk.core.error import JokeapiError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import JokeapiBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = JokeapiSDK.test(None, None)
        ...
        class TestInitFeature(JokeapiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(JokeapiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = JokeapiSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = JokeapiSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = JokeapiSDK.test(None, setup_opts)
