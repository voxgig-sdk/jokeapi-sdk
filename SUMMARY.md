...
Results: Successful response with joke(s).

SDK operations: `load`.

### Submit

Results: Joke submitted successfully or dry-run validation successful.
...
| --- | --- | --- | --- |
| Info | `list` | `GET /info` | See reference |
| Joke | `load` | `GET /joke/{category}` | See reference |
| Submit | `create` | `POST /submit` | See reference |

## Connect to the API

- JokeAPI v2 Production Server: `https://v2.jokeapi.dev`
...
- `jokeapi_list`: List records for an entity. Supported entities: `info`.
- `jokeapi_load`: Load one record for an entity. Supported entities: `joke`.
