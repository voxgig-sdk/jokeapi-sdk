...
type Args struct {
	Entity string         `json:"entity" jsonschema:"info | joke | submit"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.JokeapiSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "jokeapi_list",
		Description: "List records from Jokeapi. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "jokeapi_load",
		Description: "Load a single record from Jokeapi. " +
...
func runOp(client *sdk.JokeapiSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.JokeapiSDK, name string) (sdk.JokeapiEntity, error) {
