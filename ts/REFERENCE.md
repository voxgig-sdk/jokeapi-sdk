# Jokeapi TypeScript SDK Reference

Complete API reference for the Jokeapi TypeScript SDK.
...
#### `JokeapiSDK.test(testopts?, sdkopts?)`
...
**Returns:** `JokeapiSDK` instance in test mode.
...
Create a new `Submit` entity instance.
...
Return the parent `JokeapiSDK` instance.
