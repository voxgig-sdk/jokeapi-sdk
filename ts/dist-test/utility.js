...
function envOverride(m) {
    if ('TRUE' === process.env.JOKEAPI_TEST_LIVE ||
        'TRUE' === process.env.JOKEAPI_TEST_OVERRIDE) {
    ...
    m.JOKEAPI_TEST_EXPLAIN = process.env.JOKEAPI_TEST_EXPLAIN || m.JOKEAPI_TEST_EXPLAIN;
    return m;
}
