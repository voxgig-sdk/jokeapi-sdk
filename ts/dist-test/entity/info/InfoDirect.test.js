...
function liveScenariosActive() { return false && process.env.JOKEAPI_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.JokeapiSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['JOKEAPI_TEST_INFO_ENTID'];
    ...
    const client = new __1.JokeapiSDK({
        base: 'http://localhost:8080',
