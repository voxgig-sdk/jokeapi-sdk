...
from jokeapi_sdk.utility import register

# Load features
from jokeapi_sdk.feature.base_feature import JokeapiBaseFeature
from jokeapi_sdk.features import _has_feature, _make_feature
...
class JokeapiSDK:
    ...
    def get_utility(self):
        return JokeapiUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("JokeapiSDK: graphql: " + str(msg))
            res["graphql"] = errors
