# Jokeapi SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions JokeapiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both JokeapiSDK(...) and JokeapiSDK.test(...) become
#      JokeapiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "jokeapi_sdk"
_SDK_CLASS = "JokeapiSDK"
