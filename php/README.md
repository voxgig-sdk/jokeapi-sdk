...
The PHP SDK for the Jokeapi API — an entity-oriented client using PHP conventions.
...
```
php/
├── jokeapi_sdk.php          -- Main SDK class
...
The main class (`jokeapi_sdk.php`) exports the SDK class
