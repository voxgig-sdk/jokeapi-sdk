...
The PHP SDK for the Jokeapi API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Info(null)->list(null, null);
...
[$result, $err] = $client->Jokeapi(null)->load(
    ["id" => "test01"], null
);
