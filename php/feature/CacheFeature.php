...
class JokeapiCacheFeature extends JokeapiBaseFeature
{
    ...
    private function _through(JokeapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
