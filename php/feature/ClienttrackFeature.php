...
// Jokeapi SDK clienttrack feature
...
class JokeapiClienttrackFeature extends JokeapiBaseFeature
{
    ...
    public function PostConstruct(JokeapiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Jokeapi-SDK';
