...
class JokeapiStreamingFeature extends JokeapiBaseFeature
{
    ...
    private function _iterate(JokeapiResult $result): \Generator
    {
    ...
    private function _streamable(JokeapiContext $ctx): bool
    {
