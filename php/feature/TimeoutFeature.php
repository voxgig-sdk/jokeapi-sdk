...
class JokeapiTimeoutFeature extends JokeapiBaseFeature
{
    ...
    private function _with_timeout(JokeapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(JokeapiContext $_ctx, float $ms): void
    {
        $client = $this->client;
