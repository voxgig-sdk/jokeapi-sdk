...
// Jokeapi SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class JokeapiTestFeature extends JokeapiBaseFeature
{
    ...
    public function init(JokeapiContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (JokeapiContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (JokeapiContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(JokeapiContext $ctx, $op, $args): array
    {
