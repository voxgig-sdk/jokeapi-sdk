...
// Jokeapi SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (JokeapiSDK::test)
...
{
    private const SDK_CLASS = 'JokeapiSDK';
    ...
    private const SDK_BASE = 'jokeapi_sdk';
