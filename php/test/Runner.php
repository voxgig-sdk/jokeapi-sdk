...
class JokeapiTestRunner
{
    ...
    {
        $live = self::getenv('JOKEAPI_TEST_LIVE');
        $override = self::getenv('JOKEAPI_TEST_OVERRIDE');
        ...
        $explain = self::getenv('JOKEAPI_TEST_EXPLAIN');
...
class_alias('JokeapiTestRunner', 'Runner');
class_alias('JokeapiHelpers', 'Helpers');
