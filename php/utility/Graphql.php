...
class JokeapiGraphql
{
    ...
    // equivalent.
    public static function body(JokeapiContext $ctx): mixed
    {
    ...
    public static function errors(JokeapiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
