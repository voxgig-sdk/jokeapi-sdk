...
// Jokeapi SDK utility: fetcher

class JokeapiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; JokeapiSDK/1.0)';
    ...
    public static function call(JokeapiContext $ctx, string $fullurl, array $fetchdef): array
    {
