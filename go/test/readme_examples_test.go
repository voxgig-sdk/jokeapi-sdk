...
const testSeed = `map[string]any{"entity": map[string]any{"info": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "joke": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "submit": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
