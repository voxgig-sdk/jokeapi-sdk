...
func TestJokeEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set JOKEAPI_TEST_JOKE_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func jokeBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("JOKEAPI_TEST_JOKE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["JOKEAPI_TEST_JOKE_ENTID"])
