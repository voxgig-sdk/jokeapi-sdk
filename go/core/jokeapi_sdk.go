...
func (sdk *JokeapiSDK) OptionsMap() map[string]any {
...
func (sdk *JokeapiSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *JokeapiSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *JokeapiSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *JokeapiSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *JokeapiSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *JokeapiSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("JokeapiSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *JokeapiSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *JokeapiSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("JokeapiSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
