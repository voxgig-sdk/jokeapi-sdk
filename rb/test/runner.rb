...
module JokeapiTestRunner
  ...
  def self.env_override(m)
    live = getenv("JOKEAPI_TEST_LIVE")
    override = getenv("JOKEAPI_TEST_OVERRIDE")
    ...
    explain = getenv("JOKEAPI_TEST_EXPLAIN")
    m["JOKEAPI_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = JokeapiTestRunner
Helpers = JokeapiHelpers
Vs = VoxgigStruct
