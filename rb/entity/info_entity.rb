...
class InfoEntity
  ...
  #
  # @param reqmatch [InfoListMatch, Hash, nil] match filter (any subset of
  #   Info fields); defaults to nil, treated as an empty match that lists all.
