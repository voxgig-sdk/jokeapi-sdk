...
JokeapiSDK._make_feature = _make_feature


function JokeapiSDK.new(options)
  local self = setmetatable({}, JokeapiSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function JokeapiSDK:options_map()
...
function JokeapiSDK:get_utility()
  return Utility.copy(self._utility)
end


function JokeapiSDK:get_root_ctx()
  return self._rootctx
end


function JokeapiSDK:prepare(fetchargs)
...
function JokeapiSDK:direct(fetchargs)
...
-- by passing it.
function JokeapiSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function JokeapiSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "JokeapiSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function JokeapiSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = JokeapiSDK.new(sdkopts)
  sdk.mode = "test"
