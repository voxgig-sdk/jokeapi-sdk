...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/jokeapi` | `npm install @voxgig-sdk/jokeapi` |
| Python | `voxgig-sdk-jokeapi` | `pip install voxgig-sdk-jokeapi` |
| PHP | `voxgig-sdk/jokeapi` | `composer require voxgig-sdk/jokeapi` |
| Golang | `github.com/voxgig-sdk/jokeapi-sdk/go` | `go get github.com/voxgig-sdk/jokeapi-sdk/go` |
| Ruby | `voxgig-sdk-jokeapi` | `gem install voxgig-sdk-jokeapi` |
| Lua | `voxgig-sdk-jokeapi` | `luarocks install voxgig-sdk-jokeapi` |
